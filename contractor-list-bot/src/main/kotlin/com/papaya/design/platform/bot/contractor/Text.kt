...
object General {
    object Text {
        ...
        const val ADD_PHONE = "Введите телефон (Пример: +79151234567, если телефона нет, введите \"Нет\")"
        const val ADD_LINK = "Введите ссылку (Пример: @Link, Пример: https://google.com, если ссылки нет, введите \"Нет\")"
