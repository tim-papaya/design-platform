...
object PlannedRealisticInterior {
    object Text {
        val START_GENERATION = """
    - Загрузи мудборд, который тебе хотелось бы воплотить в жизнь.
...
""".trimIndent()
        const val WAITING_FOR_IMAGE =
            "Пожалуйста, пришлите мудборд для генерации интерьера."
    ...
    object Prompt {
        val SYSTEM_PROMPT = """
            ...
            Исходя из плана, ты должен раставить предметы с мудборда и дать фото интерьера.
