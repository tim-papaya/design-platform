...
object RoomUpgrade {
    ...
    - Загрузи фото комнаты, которую тебе хотелось бы улучшить, она может быть как пустой, так и заполненной мебелью. 
...
object RealisticInterior {
    object Text {
        ...
        Смотри, что получилось с у меня с исходником, жду твой! 
        """.trimIndent()
        const val WAITING_FOR_IMAGE =
...
""".trimIndent()
        const val WAITING_FOR_IMAGE =
            "Пожалуйста, пришлите мудбоард для генерации интерьера."
