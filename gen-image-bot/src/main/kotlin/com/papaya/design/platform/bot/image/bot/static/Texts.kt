...
object RoomUpgrade {
    ...
    object Prompt {
        val SYSTEM_PROMPT = """
            ...
            соблюдая все габариты, размеры, эргономику, текстуры и сохраняя в конечном результате уже имеющиеся предметы мебели, создай современный уютный интерьер.
...
object RealisticInterior {
    ...
    object Prompt {
        val SYSTEM_PROMPT = """
                ...
                ВСЕ ПРЕДМЕТЫ НА 3D-ВИЗУАЛИЗАЦИИ ДОЛЖНЫ БЫТЬ ОТРАЖЕНЫ В ТОЧНОСТИ КАК НА ВХОДНОМ ИЗОБРАЖЕНИИ.
